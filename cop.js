/* CRS EPSG:4326 WGS84 [lng,lat]. Path follows Lhende/Cuojian gorge to port, not Langtang. */
...
const PATH=[[85.548,28.336],[85.535,28.335],[85.520,28.334],[85.505,28.333],[85.486,28.332],[85.470,28.325],[85.455,28.318],[85.438,28.310],[85.420,28.300],[85.400,28.290],[85.3777,28.2797],[85.365,28.262],[85.356,28.248],[85.348,28.230]];
const ops={type:'FeatureCollection',features:[
{type:'Feature',properties:{layer:'sector',id:'A',name:'A 绿区',fill:'#1f7a4d'},geometry:{type:'Polygon',coordinates:[[[85.30,28.37],[85.35,28.37],[85.35,28.41],[85.30,28.41],[85.30,28.37]]]}},
...
{type:'Feature',properties:{layer:'sector',id:'C',name:'C 红区',fill:'#8a2020'},geometry:{type:'Polygon',coordinates:[[[85.368,28.272],[85.388,28.272],[85.390,28.286],[85.370,28.288],[85.368,28.272]]]}},
{type:'Feature',properties:{layer:'path',name:'Cuojian-Lhende gorge WGS84'},geometry:{type:'LineString',coordinates:PATH}},
{type:'Feature',properties:{layer:'border',name:'CN-NP border schematic'},geometry:{type:'LineString',coordinates:[[85.28,28.22],[85.36,28.268],[85.3777,28.2797],[85.43,28.31],[85.52,28.36],[85.56,28.38]]}},
...
{type:'Feature',properties:{layer:'lake',name:'barrier lake',detail:'~2.5km upstream of port'},geometry:{type:'Polygon',coordinates:[[[85.386,28.289],[85.399,28.289],[85.401,28.299],[85.387,28.300],[85.386,28.289]]]}}
]};
...
{type:'Feature',properties:{kind:'obj',name:'Source Cuojian/Chhochen',detail:'WGS84 head of gorge ~18km ENE of port. Not Langtang.'},geometry:{type:'Point',coordinates:[85.548,28.336]}}
]};
...
document.getElementById('btnBrief').onclick=()=>{log('brief'); map.flyTo({center:[PT.wide.lng,PT.wide.lat],zoom:PT.wide.z,pitch:50,bearing:70,duration:1400});};
...
log('Path snapped to Cuojian/Lhende gorge. Source is ENE of port, not Luri Himal.');
(function(){
