/* CRS: EPSG:4326 WGS84. GeoJSON is [lng,lat]. Not GCJ-02. */
...
{type:'Feature',properties:{layer:'path',name:'Chhochen/Cuojian (NP) -> Guobaxiaqu -> Port -> Timure WGS84'},geometry:{type:'LineString',coordinates:[[85.545,28.338],[85.520,28.335],[85.486,28.332],[85.450,28.310],[85.410,28.290],[85.3777,28.2797],[85.356,28.248],[85.345,28.22]]}},
...
{type:'Feature',properties:{layer:'lake',name:'barrier lake',detail:'~2.5km upstream of port WGS84'},geometry:{type:'Polygon',coordinates:[[[85.386,28.289],[85.399,28.289],[85.401,28.299],[85.387,28.300],[85.386,28.289]]]}}
]};
...
{type:'Feature',properties:{kind:'obj',name:'Gyirong Port',detail:'red zone WGS84'},geometry:{type:'Point',coordinates:[85.377744,28.279672]}},
{type:'Feature',properties:{kind:'obj',name:'Source Chhochen/Cuojian Nepal',detail:'WGS84 ~18km ENE of port, OSM valley'},geometry:{type:'Point',coordinates:[85.545,28.338]}}
]};
...
log('COP WGS84. Source=Chhochen/Cuojian ~18km ENE.');
(function(){
